...
"    meters.\n"
"\n"
"timstamp : 1D or 2D array of double, 1D or 2D array of numpy.datetime64\n"
"    Array of timestamp at wich the computation will be done.  If the array\n"
...
"    B. C.).  Moreover the shape of the array can be (M,) or (M,2) in the later\n"
"    case the row are respectively a timestamp in ut and the coresponding\n"
"    terrestrial time in ut.  In the case of (M,) it must contain only the\n"
"    timestamp in ut, in that case the terrestrial time will be computed with\n"
"    a predefined piecewise polynomial function.\n"
"\n"
"fields : List of str.\n"
